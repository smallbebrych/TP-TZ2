...
К проекту был подключен бейдж, который отображается в начале README файла.
Также результаты тестирования отправляются в телеграмм, где в сообщении отображается статус прохождения тестов. Данные сообщения можно посмотреть в группе: https://t.me/+EN9SNrFJ4l81Mzky.
